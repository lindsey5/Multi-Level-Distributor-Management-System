...
export default function Header ({ title, description } : { title: string, description: string}) {
    return (
        <header className="flex gap-5 justify-between items-center bg-white z-20 p-3 md:p-5 border-b border-[var(--border-panel)] shadow-panel shadow-md">
            <div className="flex gap-3 items-center"> 
                <div className="md:hidden w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-black">
                    <img
                        src="/logo.png"
                        alt="logo"
